...
class CreateReopenDataHistoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('reopen_data_histories', function (Blueprint $table) {
            $table->id();
            $table->string('emp_id');
    ...
    {
        Schema::dropIfExists('reopen_data_histories');
    }
}
