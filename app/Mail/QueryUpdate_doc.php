...
class QueryUpdate_doc extends Mailable
{
    ...
    public function build()
    {
        ...
        $send= $this->view('emails.query_update_doc'); 
        ...
        if(isset($this->details['manual_computation_file_url'])){
            if($this->details['manual_computation_file_url']!==""){
                $send= $this->attach($this->details['manual_computation_file_url']);       
            }
        }
        ...
        // bonus
        if($this->details['f_and_f_file_url']!==""){
            $send= $this->attach($this->details['f_and_f_file_url']);      
        }
        // t2
