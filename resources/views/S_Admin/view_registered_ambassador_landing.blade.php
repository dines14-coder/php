  ...
  <div id="app">
    <div class="main-wrapper main-wrapper-1"> 
      ...
      <div class="main-content">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                      <li class="nav-item">
                        <a class="nav-link active" onclick="pending_amb();" id="home-tab" data-toggle="tab" href="#pending_amb_tab" role="tab"
                          aria-controls="home" aria-selected="true"><i class="fas fa-exclamation-triangle"></i>&nbsp;Pending</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" onclick="declined_amb();" id="profile-tab" data-toggle="tab" href="#declined_amb_tab" role="tab"
                          aria-controls="profile" aria-selected="false"><i class="far fa-edit"></i>&nbsp;Declined</a>
                      </li>
                    </ul>
                    <div class="tab-content" id="myTabContent">
                      <div class="tab-pane fade show active" id="pending_amb_tab" role="tabpanel" aria-labelledby="home-tab">
                      ...
                      <div class="tab-pane fade" id="declined_amb_tab" role="tabpanel" aria-labelledby="home-tab">

                          <div class="card-body">
                            <div class="table-responsive">
                            <table class="table table-striped data-table" id="declined_amb_tbl">
                            <h5>Records Found: <span class="total_res_show_2"></span></h5>
                                <thead> 
                                <tr>
                                    <th>S.No</th>
                                    <th>Employee ID</th>
        ...
        @include('Layouts.reg_amb_manage_pop')
...
<script src="//cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js"></script>
  ...
  <script src="{{asset('assets/new_add/admin_js/view_reg_ambassador_landing.js')}}"></script>

  <script>
     $(document).ready(function () {
        $(".reg_ambassador_drop").addClass("active");   
        $(".reg_ambassador_a").addClass("toggled");
      })
  </script>
  
  <script>
      var get_all_reg_alumni_datatable="{{url('get_all_reg_alumni_datatable')}}"; 
      var employee_detail="{{url('employee_detail')}}"; 
      var doc_updated_detail="{{url('alumni_doc_updated_detail')}}";  
      var update_reg_alumni="{{url('update_reg_alumni')}}";  
      var send_emp_status_mail="{{url('send_emp_status_mail')}}"; 
      var get_all_declined_alumni_datatable="{{url('get_all_declined_alumni_datatable')}}"; 
