...
<body>
        ...
        <div class="modal fade bd-example-modal-lg" id="doc_show_pop" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              {{-- <h6>Remar2k:<span id="doc_s_emp_remark"></span></h6> --}}
  ...
  <script>
     $(document).ready(function () {
        ...
        $(".query_status_li").addClass("active");
        $(".query_status_a").addClass("toggled");  
      })
  </script>

  <script src="{{asset('assets/new_add/js/query_status.js')}}"></script>

  <script>
      var get_emp_all_quer_data="{{url('get_all_emp_query')}}"; 
      var doc_updated_detail_emp="{{url('doc_updated_detail_emp')}}"; 
  </script>
