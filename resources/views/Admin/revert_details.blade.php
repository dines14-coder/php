                            ...
                            <div class="col-12 col-sm-12 col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4>Revert Details</h4>
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table id="revert_table" class="table table-bordered" cellspacing="0"
                                                width="100%">
                                                <thead>
                                                    <tr>
                                                        <th>S.No</th>
...
@endverbatim
    ...
    <script src="//cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js"></script>
    <script src="{{ asset('assets/new_add/admin_js/revert_details.js') }}"></script>
    <script>
        $(document).ready(function() {
            $(".revert_drop").addClass("active");
            $(".revert_details").addClass("toggled");
        })
    </script>
</body>
<!-- tabs.html  21 Nov 2019 03:54:41 GMT -->
