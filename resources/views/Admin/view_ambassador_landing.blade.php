  ...
  <div id="app">
    <div class="main-wrapper main-wrapper-1">
      ...
      <div class="main-content">
        ...
        @include('Layouts.ambassador_edit_pop')
        @include('Layouts.reset_password_amb_pop')
...
<script src="//cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js"></script>
  ...
  <script>
      ...
      var f_and_f_document_pop="{{url('f_and_f_document_popup')}}";  
      var downloadPDF="{{url('downloadPDF')}}";
      var update_amb_form="{{url('update_amb_form')}}";
      var reset_password="{{url('reset_password')}}";
