                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table id="mis_table" class="table table-bordered" cellspacing="0"
                                                width="100%">
                                                <thead>
                                                    <tr>
                                                        <th>S.No</th>
                                                        ...
                                                        <th>Received Date</th>
                                                        <th>Received Time</th>
                                                        <th>QC Observations</th>
                                                        <th>QC Observations</th>
                                                        <th>Observation Mail Sent to HR - date</th>
                                                        <th>Observation Mail Sent to HR - time</th>
                                                        <th>Revised mail received from HR - Date</th>
                                                        <th>Revised mail received from HR - time</th>
                                                        <th>Amount</th>
                                                        <th>Mail Sent to Finance</th>
                                                        <th>Date</th>
                                                        <th>Time</th>
                                                        <th>Status</th>
                                                    </tr>
...
@endverbatim
    ...
    <script src="//cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js"></script>
    <script src="{{ asset('assets/new_add/admin_js/qc_mis.js') }}"></script>
    <script type="text/javascript" src="https://cdn.jsdelivr.net/momentjs/latest/moment.min.js"></script>
    <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.min.js"></script>
    <script>
        $(document).ready(function() {
            $(".qc_mis_drop").addClass("active");
            $(".qc_mis_details").addClass("toggled");
        })
    </script>
</body>
<!-- tabs.html  21 Nov 2019 03:54:41 GMT -->
