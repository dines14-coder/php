  ...
  <div id="app">
    <div class="main-wrapper main-wrapper-1">
      ...
      <div class="main-content">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                      ...
                      <li class="nav-item">
                        <a class="nav-link"  onclick="completed_tab_click();"  id="completed-tab" data-toggle="tab" href="#completed_query_tab" role="tab"
                          aria-controls="completed" aria-selected="false"><i class="fas fa-check"></i>&nbsp;Completed</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" onclick="declined_tab_click();" id="declined-tab" data-toggle="tab" href="#declined_query_tab" role="tab"
                          aria-controls="declined" aria-selected="false"><i class="fas fa-trash"></i>&nbsp;Declined</a>
                      </li>
                    </ul>
        ...
        @include('Layouts.reassign_edit_pop')
...
<script src="//cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js"></script>
  ...
  <script src="{{asset('assets/new_add/admin_js/query_manage_landing.js')}}"></script> 
  ...
  <script>
      var get_admin_query_datatable="{{url('get_admin_query_datatable')}}";  
      var employee_detail="{{url('employee_detail')}}"; 
      var update_query="{{url('update_query_status')}}"; 
      var reassign_query="{{url('reassign_query_status')}}"; 
      var reassign_form="{{url('update_reassign_form')}}"; 
